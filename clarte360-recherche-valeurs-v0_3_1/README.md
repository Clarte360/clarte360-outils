...
- Application : **2.2.0-preproduction-2**
...
## Version 2.2.0-preproduction-2 — 4 septembre 2026

Cette version applique le référentiel conversationnel RVC360 V2.5 : qualité d'expression structurée (correction / reformulation / clarification / échec technique) et sélection multi-hypothèses dans le Module 4. Voir `CHANGELOG_V2.2.0.md`.
