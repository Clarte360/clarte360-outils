...
def test_initial_text_and_voice_use_classifier():
    ...
    assert widget.count("difference_kind=_text_difference_kind") >= 3
    assert "Version légèrement corrigée" in widget
    assert "Proposition Clarté360" in widget
